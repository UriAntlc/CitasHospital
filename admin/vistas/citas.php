            ...
            <div id="content">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle"
                                    src="../../img/undraw_profile.svg"> <!-- Foto Usuario -->
                            </a>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card-header py-3">
                        ...
                        <br>
                        <a href="../acciones/agendar_cita.php">
                            <button type="button" class="btn btn-success" data-toggle="modal" data-target="#user">
                                <span class="glyphicon glyphicon-plus"></span> Agendar Cita <i class="fa fa-user-plus"></i>
                            </button>
                        </a>
                    </div>
                        <div class="card-body">
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            ue.nombre as doctor, ue.apellido as doctor_ap, s.nombre as servicio, c.costo as costo, cu.disponibilidad as disponibilidad
                                            FROM Cita AS c 
                                            ...
                                            if($result){
                                                while($row = mysqli_fetch_assoc($result)){
                                                    $id_cita = $row['cita'];
                                                    $id_pac = $row['id_pac'];
                                                    $paciente = $row['paciente'] . ' ' . $row['apellido'];
                                                    $id_consul = $row['consultorio'];
                                                    $doctor = $row['doctor'] . ' ' . $row['doctor_ap'];
                                                    $fecha = $row['fecha'];
                                                    ...
                                                    <td>'.$estado.'</td>
                                                    <td>
                                                    <a class="btn btn-warning" href="../acciones/update_cita.php?updateid_cita='.$id_cita.'&updateid_consul='.$id_consul.'&updateid_pac='.$id_pac.'&update_costo='.$costo.'">
                                                        <i class="fa fa-edit "></i> </a>
                                                    <a href="../acciones/delete_cita.php?deleteid_cita='.$id_cita.'" class="btn btn-danger btn-del">
                                                        <i class="fa fa-trash "></i></a></button>
                                                    </td>
                                                    </tr>';
                                                }//boton por si no sirve la a de arriva, editar si funcina
                                                //<button class="btn btn-primary"><a href="../acciones/delete_cita.php?deleteid_cita='.$id_cita.'" class="text-dark">Eliminar</a></button>
                                            }
                                        ?>
                                    </tbody>
                                </table>
