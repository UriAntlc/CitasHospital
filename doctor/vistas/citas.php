...
$nuser = "SELECT nombre, apellido, tipo_usuario FROM Usuario WHERE correo = '$actualsesion'";
...
if ($actualsesion == null || $actualsesion == '' || $type_usuario != 2) {
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <?php
                                            $vista = "SELECT c.ID_Cita as id_cita, u.nombre as paciente, c.fecha as fecha, c.Consultorio_ID as consultorio, 
                                            s.nombre as servicio , c.costo as costo, d.ID_Doctor as id_doctor, u.ID_Usuario as id_usuario
                                            FROM Cita AS c 
                                            ...
                                            if($result){
                                                while($row = mysqli_fetch_assoc($result)){
                                                    ...
                                                    <td>'.$costo.'</td>
                                                    <td>
                                                    <a href="../acciones/generar_receta.php?genid_cita='.$id_cita.'&genid_user='.$id_user.'">
                                                        <button type="button" class="btn btn-success" data-toggle="modal">
                                                            <span class="glyphicon glyphicon-plus"></span> Generar receta <i class="fa fa-user-plus"></i>
                                                        </button>
                                                    </a>
                                                    <a href="../vistas/historial.php?expid_user='.$id_user.'">
                                                        <button type="button" class="btn btn-secondary" data-toggle="modal">
                                                            <span class="glyphicon glyphicon-plus"></span> Historial <i class="fa fa-plus"></i>
                                                        </button>
                                                    </a>
                                                    </td>
                                                    </tr>';
                                                    /*
                                                    botones
                                                    <a href="../../admin/acciones/update_cita.php?updateid_cita='.$id_cita.'&updateid_consul='.$id_consul.'&updateid_pac='.$id_user.'&update_costo='.$costo.'">
                                                        <button type="button" class="btn btn-info" data-toggle="modal"> 
                                                            <span class="glyphicon glyphicon-plus"></span>Cambiar <i class="fa fa-edit "></i>
                                                        </button>
                                                    </a>
                                                    
                                                    <a href="../../admin/acciones/delete_cita.php?deleteid_cita='.$id_cita.'">
                                                        <button type="button" class="btn btn-primary">
                                                            <span class="glyphicon glyphicon-plus"></span> Eliminar <i class="fa fa-trash "></i>
                                                        </button>
                                                    </a>
                                                    */
                                                }
