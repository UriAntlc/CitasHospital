                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <?php
                                            $vista = "SELECT r.ID_Receta as id_receta, u.nombre as nombre, u.apellido as apellido,r.descripcion as descripcion, m.nombre as medicamento, m.cantidad as cantidad, m.presentacion as presentacion, t.fecha_inicio as inicio, t.fecha_fin as fin
                                            FROM Receta as r 
                                            ...
                                            INNER JOIN Doctor as d on d.ID_Doctor = cu.Doctor_ID WHERE d.ID_Doctor = $doctor_id";
